"""
XGBoost model training for HAR with enhanced features.
5-fold subject-wise cross-validation with 7:1:2 train/val/test split.
Uses sqrt-softened class weighting to handle imbalanced classes.
"""
...
OUTPUT_PATH = "PAAWS_FreeLiving_results_xgboost_v2/"
...
def train_and_evaluate(df: pl.DataFrame, feature_cols: list):
    ...
    for fold in range(n_folds):
        ...
        # Custom weights: full balanced weight for Biking, sqrt-softened for others

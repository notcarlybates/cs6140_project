"""
Experiment 3b: Stacking Ensemble with Advanced Features (v3)
Combines XGBoost, LightGBM, and MLP as base models on advanced features.
Compare results with exp_3_stacking_ensemble.py (v2) to see if advanced features help.
"""
...
OUTPUT_PATH = "sams_experiments/results_stacking_v3/"
...
def train_and_evaluate(df: pl.DataFrame, feature_cols: list):
    ...
    for fold in range(N_FOLDS):
        ...
        # Train meta-learner on training set
    ...
    print(f"\n{'='*60}")
    print("OVERALL RESULTS - Stacking Ensemble (v3 Advanced Features)")
    print(f"{'='*60}")

"""
Experiment 2: LightGBM Classifier
Gradient boosting alternative to XGBoost.
Often faster and sometimes better generalization.
"""
...
OUTPUT_PATH = "sams_experiments/results_lightgbm/"
...
def train_and_evaluate(df: pl.DataFrame, feature_cols: list):
    ...
    print(f"\n{'='*60}")
    print("OVERALL RESULTS - LightGBM")
    print(f"{'='*60}")

"""
Experiment 5b: Hyperparameter Tuning with Optuna on Advanced Features (v3)
Systematic Bayesian search over XGBoost hyperparameters using advanced features.
Compare results with exp_5_hyperparameter_tuning.py (v2) to see if advanced features help.
"""
...
OUTPUT_PATH = "sams_experiments/results_optuna_v3/"
...
def main():
    ...
    print("Using advanced features (v3)")
    print(f"{'='*60}\n")
    ...
    print(f"\n{'='*60}")
    print("Best Hyperparameters (v3 Advanced Features):")
    print(f"{'='*60}")
